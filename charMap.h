...
const uint8_t charMap[][4] PROGMEM = {
    {0x00, 0x00, 0x00, 0x00}, //   0x20 32
    {0x00, 0x00, 0x00, 0x00}, // ! 0x21 33
    {0x00, 0x07, 0x07, 0x00}, // " 0x22 34
    {0x14, 0x7f, 0x7f, 0x14}, // # 0x23 35
    {0x8C, 0x92, 0x92, 0x62}, // $ 0x24 36
    {0x23, 0x13, 0x64, 0x62}, // % 0x25 37
    {0x36, 0x49, 0x20, 0x50}, // & 0x26 38
    {0x00, 0x00, 0x00, 0x00}, // ' 0x27 39
    {0x00, 0x1c, 0x41, 0x00}, // ( 0x28 40
    {0x00, 0x41, 0x1c, 0x00}, // ) 0x29 41
    {0x14, 0x08, 0x08, 0x14}, // * 0x2a 42
    {0x08, 0x08, 0x08, 0x08}, // + 0x2b 43
    {0x00, 0x50, 0x00, 0x00}, // , 0x2c 44
    {0x08, 0x08, 0x08, 0x08}, // - 0x2d 45
    {0x00, 0x60, 0x00, 0x00}, // . 0x2e 46
    {0x20, 0x10, 0x04, 0x02}, // / 0x2f 47
    {0x3e, 0x41, 0x41, 0x3e}, // 0 0x30 48
    {0x00, 0x42, 0x7f, 0x40}, // 1 0x31 49
    {0x62, 0b1010001, 0x49, 0x46}, // 2 0x32 50
    {0b0100010, 0b1000001, 0b1001001, 0b0110110}, // 3 0x33 51
    {0b0011000, 0b0010100, 0b0010010, 0x7f}, // 4 0x34 52
    {0x27, 0x45, 0x45, 0x39}, // 5 0x35 53
    {0x3c, 0x4a, 0x49, 0x30}, // 6 0x36 54
    {0x01, 0b1111001, 0x05, 0x03}, // 7 0x37 55
    {0x36, 0x49, 0x49, 0x36}, // 8 0x38 56
    {0x06, 0x49, 0x29, 0x1e}, // 9 0x39 57
    {0x00, 0x36, 0x00, 0x00} // : 0x3a 58
